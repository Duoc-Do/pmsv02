...
$(document).ready(function (event) {
    ...
    //$('.senviet-grid-btn-addrow').focus(function () {
    //    //$(this).click();
    //    senvietgridaddrow(this);
    //});

    //$('.senviet-grid-btn-addrow').click(function (e) {
    //    e.stopPropagation();
    //    senvietgridaddrow(this);
    //});

    $('select[isautocomplete = "isautocomplete"]').each(function (i) {
        var pathautocomplete = '/Admin/Services/autocomplete';
    ...
    //$(".datetime-g").datetimepicker({ datetimeFormat: 'D/O/Y H:M', spinnerImage: '' }); // phai3 thay the6
