...
namespace WebApp.Areas.Pos.Controllers
{
    ...
    public class AppAccountController : AccountingController
    {
        //
        // GET: /Account/Login
        string pnameusername = "pos.login.serviceid_{0}.username";
        string pnamepassword = "pos.login.serviceid_{0}.password";
        ...
        private ActionResult RedirectToLocal(string returnUrl)
        {
            ...
            {
                return RedirectToAction("Index", "AppHome", new { area = "Pos" });
            }
        }
    }
