...
{
    public class RpAccountLedgerExpenseController : AppAccountingReportController
    {
        DAL.RpAccountLedgerExpense _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpAccountLedgerExpense(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpAccountLedgerExpense>();
