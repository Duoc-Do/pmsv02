...
{
    public class RpAccountLedgerController : AppAccountingReportController
    {
        DAL.RpAccountLedger _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpAccountLedger(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpAccountLedger>();
