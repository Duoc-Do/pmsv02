...
{
    public class RpStockCardController : AppAccountingReportController
    {
        DAL.RpStockCard _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpStockCard(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpStockCard>();
