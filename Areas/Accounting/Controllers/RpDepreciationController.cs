...
{
    public class RpDepreciationController : AppAccountingReportController
    {
        DAL.RpDepreciation _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpDepreciation(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpDepreciation>();
