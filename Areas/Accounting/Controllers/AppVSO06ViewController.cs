...
{
    public class AppVSO06ViewController : AppAccountingVoucherController
    {
        DAL.AppVSO06View _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppVSO06View(Request);
        ...
        {
            return Services.Report.Print.PrintVoucher<Models.AppVSO06PrintView>(this, id, sysreportid, reporttype, new System.Collections.Hashtable());
        }
        ...
        public ActionResult Create(Models.AppVSO06View collection)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(long id, Models.AppVSO06View collection)
        {
            // TODO: Add insert logic here
            try
            {
