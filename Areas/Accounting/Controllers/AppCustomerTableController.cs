...
{
    public class AppCustomerTableController : AppAccountingListController
    {
        DAL.AppCustomerTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppCustomerTable(Request);
        ...
        public ActionResult Create(Models.AppCustomerView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppCustomerView collection)
        {
            try
            {
