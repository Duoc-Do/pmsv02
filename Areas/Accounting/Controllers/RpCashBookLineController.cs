...
{
    public class RpCashBookLineController : AppAccountingReportController
    {
        DAL.RpCashBookLine _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpCashBookLine(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpCashBookLine>();
