...
{
    public class RpTrialBalanceExpenseController : AppAccountingReportController
    {
        DAL.RpTrialBalanceExpense _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpTrialBalanceExpense(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpTrialBalanceExpense>();
