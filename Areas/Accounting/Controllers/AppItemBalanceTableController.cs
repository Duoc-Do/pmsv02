...
{
    public class AppItemBalanceTableController : AppAccountingListController
    {
        DAL.AppItemBalanceTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppItemBalanceTable(Request);
        ...
        {
            DAL.AppItemBalanceTable _dataobject = new DAL.AppItemBalanceTable(Request);
        ...
        public ActionResult Create(Models.AppItemBalanceView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppItemBalanceView collection)
        {
            try
            {
