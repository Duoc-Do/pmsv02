...
{
    public class AppFixedAssetGroupTableController : AppAccountingListController
    {
        DAL.AppFixedAssetGroupTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppFixedAssetGroupTable(Request);
        ...
        {
            DAL.AppFixedAssetGroupTable _dataobject = new DAL.AppFixedAssetGroupTable(Request);
        ...
        public ActionResult Create(Models.AppFixedAssetGroupTable collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppFixedAssetGroupTable collection)
        {
            try
            {
