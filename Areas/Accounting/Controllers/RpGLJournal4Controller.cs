...
{
    public class RpGLJournal4Controller : AppAccountingReportController
    {
        DAL.RpGLJournal4 _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpGLJournal4(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpGLJournal4>();
