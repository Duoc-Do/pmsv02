...
{
    public class RpIncomeStatementController : AppAccountingReportController
    {
        DAL.RpIncomeStatement _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpIncomeStatement(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpIncomeStatement>();
