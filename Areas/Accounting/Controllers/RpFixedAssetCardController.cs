...
{
    public class RpFixedAssetCardController : AppAccountingReportController
    {
        DAL.RpFixedAssetCard _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpFixedAssetCard(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpFixedAssetCard>();
