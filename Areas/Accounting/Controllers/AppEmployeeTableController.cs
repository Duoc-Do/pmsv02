...
{
    public class AppEmployeeTableController : AppAccountingListController
    {
        DAL.AppEmployeeTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppEmployeeTable(Request);
        ...
        {
            DAL.AppEmployeeTable _dataobject = new DAL.AppEmployeeTable(Request);
        ...
        public ActionResult Create(Models.AppEmployeeView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppEmployeeView collection)
        {
            try
            {
