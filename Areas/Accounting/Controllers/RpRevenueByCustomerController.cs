...
{
    public class RpRevenueByCustomerController : AppAccountingReportController
    {
        DAL.RpRevenueByCustomer _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpRevenueByCustomer(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpRevenueByCustomer>();
