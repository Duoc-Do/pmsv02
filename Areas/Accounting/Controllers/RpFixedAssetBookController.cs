...
{
    public class RpFixedAssetBookController : AppAccountingReportController
    {
        DAL.RpFixedAssetBook _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpFixedAssetBook(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpFixedAssetBook>();
