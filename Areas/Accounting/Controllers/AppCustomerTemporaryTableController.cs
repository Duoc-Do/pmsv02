...
{
    public class AppCustomerTemporaryTableController : AppAccountingListController
    {
        DAL.AppCustomerTemporaryTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppCustomerTemporaryTable(Request);
        ...
        {
            DAL.AppCustomerTemporaryTable _dataobject = new DAL.AppCustomerTemporaryTable(Request);
        ...
        public ActionResult Create(Models.AppCustomerTemporaryView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppCustomerTemporaryView collection)
        {
            try
            {
