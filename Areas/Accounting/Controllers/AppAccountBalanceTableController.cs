...
{
    public class AppAccountBalanceTableController : AppAccountingListController
    {
        DAL.AppAccountBalanceTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppAccountBalanceTable(Request);
        ...
        {
            DAL.AppWarehouseTable _dataobject = new DAL.AppWarehouseTable(Request);
        ...
        public ActionResult Create(Models.AppAccountBalanceView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppAccountBalanceView collection)
        {
            try
            {
