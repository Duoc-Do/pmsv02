...
{
    public class SysBusinessController : AppAccountingListController
    {
        DAL.SysBusiness _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.SysBusiness(Request);
        ...
        {
            DAL.SysBusiness _dataobject = new DAL.SysBusiness(Request);
        ...
        public ActionResult Create(Models.SysBusiness collection)
        {
            try
            {
