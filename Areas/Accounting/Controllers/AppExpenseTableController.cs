...
{
    public class AppExpenseTableController : AppAccountingListController
    {
        DAL.AppExpenseTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppExpenseTable(Request);
        ...
        {
            DAL.AppExpenseTable _dataobject = new DAL.AppExpenseTable(Request);
        ...
        public ActionResult Create(Models.AppExpenseTable collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppExpenseTable collection)
        {
            try
            {
