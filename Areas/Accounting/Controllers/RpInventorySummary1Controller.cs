...
{
    public class RpInventorySummary1Controller : AppAccountingReportController
    {
        DAL.RpInventorySummary1 _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpInventorySummary1(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpInventorySummary1>();
