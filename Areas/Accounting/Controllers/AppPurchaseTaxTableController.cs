...
{
    public class AppPurchaseTaxTableController : AppAccountingListController
    {
        DAL.AppPurchaseTaxTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppPurchaseTaxTable(Request);
        ...
        {
            DAL.AppPurchaseTaxTable _dataobject = new DAL.AppPurchaseTaxTable(Request);
        ...
        public ActionResult Create(Models.AppPurchaseTaxView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppPurchaseTaxView collection)
        {
            try
            {
