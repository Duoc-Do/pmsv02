...
{
    public class AppCustomerBalanceTableController : AppAccountingListController
    {
        DAL.AppCustomerBalanceTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppCustomerBalanceTable(Request);
        ...
        {
            DAL.AppCustomerBalanceTable _dataobject = new DAL.AppCustomerBalanceTable(Request);
        ...
        public ActionResult Create(Models.AppCustomerBalanceView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppCustomerBalanceView collection)
        {
            try
            {
