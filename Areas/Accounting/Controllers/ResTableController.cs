...
{
    public class ResTableController : AppAccountingListController
    {
        DAL.ResTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.ResTable(Request);
        ...
        {
            DAL.ResTable _dataobject = new DAL.ResTable(Request);
        ...
        public ActionResult Create(Models.ResTableView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.ResTableView collection)
        {
            try
            {
