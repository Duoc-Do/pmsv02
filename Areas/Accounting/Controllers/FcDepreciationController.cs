...
{
    public class FcDepreciationController : AppAccountingFunctionController
    {
        ...
        {
            _dataobject = new DAL.SenVietGeneralObject(Request, "FcDepreciation");
        ...
        public ActionResult Edit2(FormCollection collection)
        {
            ...
            try
            {
                _dataobject._db.Database.ExecuteSqlCommand(string.Format("sp_FcDepreciation {0},{1}", month, year));
