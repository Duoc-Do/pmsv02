...
{
    public class AppCurrencyTableController : AppAccountingListController
    {
        DAL.AppCurrencyTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppCurrencyTable(Request);
        ...
        public ActionResult Create(Models.AppCurrencyTable collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppCurrencyTable collection)
        {
            try
            {
