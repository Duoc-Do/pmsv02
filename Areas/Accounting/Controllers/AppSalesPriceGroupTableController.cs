...
{
    public class AppSalesPriceGroupTableController : AppAccountingListController
    {
        DAL.AppSalesPriceGroupTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppSalesPriceGroupTable(Request);
        ...
        {
            DAL.AppSalesPriceGroupTable _dataobject = new DAL.AppSalesPriceGroupTable(Request);
        ...
        public ActionResult Create(Models.AppSalesPriceGroupTable collection)
        {
            try
            {
