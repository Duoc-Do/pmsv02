...
{
    public class AppVPO05ViewController : AppAccountingVoucherController
    {
        DAL.AppVPO05View _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppVPO05View(Request);
        ...
        {
            return Services.Report.Print.PrintVoucher<Models.AppVPO05PrintView>(this, id, sysreportid, reporttype, new System.Collections.Hashtable());
        }
        ...
        public ActionResult Create(Models.AppVPO05View collection)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(long id, Models.AppVPO05View collection)
        {
            // TODO: Add insert logic here
            try
            {
