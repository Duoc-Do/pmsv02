...
{
    public class RpBalanceSheetController : AppAccountingReportController
    {
        DAL.RpBalanceSheet _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpBalanceSheet(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpBalanceSheet>();
