...
{
    public class AppVIN05ViewController : AppAccountingVoucherController
    {
        DAL.AppVIN05View _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppVIN05View(Request);
        ...
        {
            return Services.Report.Print.PrintVoucher<Models.AppVIN05PrintView>(this, id, sysreportid, reporttype, new System.Collections.Hashtable());
        }
        ...
        public ActionResult Create(Models.AppVIN05View collection)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(long id, Models.AppVIN05View collection)
        {
            // TODO: Add insert logic here
            try
            {
