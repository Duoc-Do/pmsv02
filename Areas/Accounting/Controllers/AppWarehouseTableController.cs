...
{
    public class AppWarehouseTableController : AppAccountingListController
    {
        DAL.AppWarehouseTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppWarehouseTable(Request);
        ...
        public ActionResult Create(Models.AppWarehouseView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppWarehouseView collection)
        {
            try
            {
