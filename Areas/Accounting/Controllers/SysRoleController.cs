...
{
    public class SysRoleController : AppAccountingListController
    {
        DAL.SysRole _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.SysRole(Request);
        ...
        public ActionResult Create(Models.SysRole collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.SysRole collection)
        {
            try
            {
