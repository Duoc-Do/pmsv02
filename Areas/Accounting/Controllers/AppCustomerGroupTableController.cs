...
{
    public class AppCustomerGroupTableController : AppAccountingListController
    {
        DAL.AppCustomerGroupTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppCustomerGroupTable(Request);
        ...
        {
            DAL.AppCustomerGroupTable _dataobject = new DAL.AppCustomerGroupTable(Request);
        ...
        public ActionResult Create(Models.AppCustomerGroupView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppCustomerGroupView collection)
        {
            try
            {
