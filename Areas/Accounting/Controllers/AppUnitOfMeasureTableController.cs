...
{
    public class AppUnitOfMeasureTableController : AppAccountingListController
    {
        DAL.AppUnitOfMeasureTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppUnitOfMeasureTable(Request);
        ...
        {
            DAL.AppUnitOfMeasureTable _dataobject = new DAL.AppUnitOfMeasureTable(Request);
        ...
        public ActionResult Create(Models.AppUnitOfMeasureView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppUnitOfMeasureView collection)
        {
            try
            {
