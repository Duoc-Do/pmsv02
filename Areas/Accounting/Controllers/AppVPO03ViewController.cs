...
{
    public class AppVPO03ViewController : AppAccountingVoucherController
    {
        DAL.AppVPO03View _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppVPO03View(Request);
        ...
        {
            return Services.Report.Print.PrintVoucher<Models.AppVPO03PrintView>(this, id, sysreportid, reporttype, new System.Collections.Hashtable());
        }
        ...
        public ActionResult Create(Models.AppVPO03View collection)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(long id, Models.AppVPO03View collection)
        {
            // TODO: Add insert logic here
            try
            {
