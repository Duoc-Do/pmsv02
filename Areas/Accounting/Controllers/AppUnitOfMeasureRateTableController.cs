...
{
    public class AppUnitOfMeasureRateTableController : AppAccountingListController
    {
        DAL.AppUnitOfMeasureRateTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppUnitOfMeasureRateTable(Request);
        ...
        {
            DAL.AppUnitOfMeasureRateTable _dataobject = new DAL.AppUnitOfMeasureRateTable(Request);
        ...
        public ActionResult Create(Models.AppUnitOfMeasureRateView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppUnitOfMeasureRateView collection)
        {
            try
            {
