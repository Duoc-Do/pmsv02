...
{
    public class RpOutputVATController : AppAccountingReportController
    {
        DAL.RpOutputVAT _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpOutputVAT(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpOutputVAT>();
