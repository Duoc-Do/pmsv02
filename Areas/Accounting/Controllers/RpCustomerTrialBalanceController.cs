...
{
    public class RpCustomerTrialBalanceController : AppAccountingReportController
    {
        DAL.RpCustomerTrialBalance _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpCustomerTrialBalance(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpCustomerTrialBalance>();
