...
{
    public class RpCashFlowInDirectController : AppAccountingReportController
    {
        DAL.RpCashFlowInDirect _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpCashFlowInDirect(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpCashFlowInDirect>();
