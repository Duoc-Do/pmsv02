...
{
    public class AppVSO02ViewController : AppAccountingVoucherController
    {
        DAL.AppVSO02View _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppVSO02View(Request);
        ...
        {
            return Services.Report.Print.PrintVoucher<Models.AppVSO02PrintView>(this, id, sysreportid, reporttype, new System.Collections.Hashtable());
        }
        ...
        public ActionResult Create(Models.AppVSO02View collection)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(long id, Models.AppVSO02View collection)
        {
            // TODO: Add insert logic here
            try
            {
