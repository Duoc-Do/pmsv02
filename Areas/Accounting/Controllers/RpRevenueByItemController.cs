...
{
    public class RpRevenueByItemController : AppAccountingReportController
    {
        DAL.RpRevenueByItem _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpRevenueByItem(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpRevenueByItem>();
