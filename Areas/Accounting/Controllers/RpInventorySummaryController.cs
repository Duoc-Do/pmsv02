...
{
    public class RpInventorySummaryController : AppAccountingReportController
    {
        DAL.RpInventorySummary _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpInventorySummary(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpInventorySummary>();
