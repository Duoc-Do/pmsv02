...
{
    public class AppVCA04ViewController : AppAccountingVoucherController
    {
        DAL.AppVCA04View _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppVCA04View(Request);
        ...
        {
            return Services.Report.Print.PrintVoucher<Models.AppVCA04PrintView>(this, id, sysreportid, reporttype, new System.Collections.Hashtable());
        }
        ...
        public ActionResult Create(Models.AppVCA04View collection)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(long id, Models.AppVCA04View collection)
        {
            // TODO: Add insert logic here
            try
            {
