...
{
    public class AppVIN04ViewController : AppAccountingVoucherController
    {
        DAL.AppVIN04View _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppVIN04View(Request);
        ...
        {
            return Services.Report.Print.PrintVoucher<Models.AppVIN04PrintView>(this, id, sysreportid, reporttype, new System.Collections.Hashtable());
        }
        ...
        public ActionResult Create(Models.AppVIN04View collection)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(long id, Models.AppVIN04View collection)
        {
            // TODO: Add insert logic here
            try
            {
