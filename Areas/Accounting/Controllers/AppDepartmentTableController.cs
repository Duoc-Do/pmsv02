...
{
    public class AppDepartmentTableController : AppAccountingListController
    {
        DAL.AppDepartmentTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppDepartmentTable(Request);
        ...
        {
            DAL.AppDepartmentTable _dataobject = new DAL.AppDepartmentTable(Request);
        ...
        public ActionResult Create(Models.AppDepartmentTable collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppDepartmentTable collection)
        {
            try
            {
