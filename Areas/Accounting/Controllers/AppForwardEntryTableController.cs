...
{
    public class AppForwardEntryTableController : AppAccountingListController
    {
        DAL.AppForwardEntryTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppForwardEntryTable(Request);
        ...
        {
            DAL.AppForwardEntryTable _dataobject = new DAL.AppForwardEntryTable(Request);
        ...
        public ActionResult Create(Models.AppForwardEntryView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppForwardEntryView collection)
        {
            try
            {
