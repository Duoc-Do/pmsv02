...
{
    public class GapTreeController : AppAccountingListController
    {
        DAL.GapTree _dataobject;
        ...
        public ActionResult Create(Models.GapTree collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int TreeId, Models.GapTree collection)
        {
            try
            {
