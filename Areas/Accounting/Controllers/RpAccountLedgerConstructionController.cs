...
{
    public class RpAccountLedgerConstructionController : AppAccountingReportController
    {
        DAL.RpAccountLedgerConstruction _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpAccountLedgerConstruction(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpAccountLedgerConstruction>();
