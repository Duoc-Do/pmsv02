...
{
    public class AppWorkTableController : AppAccountingListController
    {
        DAL.AppWorkTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppWorkTable(Request);
        ...
        {
            DAL.AppWorkTable _dataobject = new DAL.AppWorkTable(Request);
        ...
        public ActionResult Create(Models.AppWorkTable collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int WorkID, Models.AppWorkTable collection)
        {
            try
            {
