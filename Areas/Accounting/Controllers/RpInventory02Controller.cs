...
{
    public class RpInventory02Controller : AppAccountingReportController
    {
        DAL.RpInventory02 _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpInventory02(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpInventory02>();
