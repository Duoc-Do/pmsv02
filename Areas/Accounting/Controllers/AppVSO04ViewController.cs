...
{
    public class AppVSO04ViewController : AppAccountingVoucherController
    {
        DAL.AppVSO04View _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppVSO04View(Request);
        ...
        {
            return Services.Report.Print.PrintVoucher<Models.AppVSO04PrintView>(this, id, sysreportid, reporttype, new System.Collections.Hashtable());
        }
        ...
        public ActionResult Create(Models.AppVSO04View collection)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(long id, Models.AppVSO04View collection)
        {
            // TODO: Add insert logic here
            try
            {
