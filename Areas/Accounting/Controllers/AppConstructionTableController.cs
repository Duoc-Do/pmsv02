...
{
    public class AppConstructionTableController : AppAccountingListController
    {
        DAL.AppConstructionTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppConstructionTable(Request);
        ...
        public ActionResult Create(Models.AppConstructionView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppConstructionView collection)
        {
            try
            {
