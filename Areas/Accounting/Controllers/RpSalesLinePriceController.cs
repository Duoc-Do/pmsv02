...
{
    public class RpSalesLinePriceController : AppAccountingReportController
    {

        DAL.RpSalesLinePrice _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpSalesLinePrice(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpSalesLinePrice>();
