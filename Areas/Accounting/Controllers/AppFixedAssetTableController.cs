...
{
    public class AppFixedAssetTableController : AppAccountingListController
    {
        DAL.AppFixedAssetTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppFixedAssetTable(Request);
        ...
        {
            DAL.AppFixedAssetTable _dataobject = new DAL.AppFixedAssetTable(Request);
        ...
        public ActionResult Create(Models.AppFixedAssetView collection)
        {
            try
            {
