...
{
    public class RpGeneralLedgerTController : AppAccountingReportController
    {
        DAL.RpGeneralLedgerT _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpGeneralLedgerT(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpGeneralLedgerT>();
