...
{
    public class RpSalesLedgerController : AppAccountingReportController
    {
        DAL.RpSalesLedger _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpSalesLedger(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpSalesLedger>();
