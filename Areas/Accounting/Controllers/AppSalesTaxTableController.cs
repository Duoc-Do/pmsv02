...
{
    public class AppSalesTaxTableController : AppAccountingListController
    {
        DAL.AppSalesTaxTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppSalesTaxTable(Request);
        ...
        {
            DAL.AppSalesTaxTable _dataobject = new DAL.AppSalesTaxTable(Request);
        ...
        public ActionResult Create(Models.AppSalesTaxView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppSalesTaxView collection)
        {
            try
            {
