...
{
    public class AppVSO03ViewController : AppAccountingVoucherController
    {
        DAL.AppVSO03View _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppVSO03View(Request);
        ...
        {
            return Services.Report.Print.PrintVoucher<Models.AppVSO03PrintView>(this, id, sysreportid, reporttype, new System.Collections.Hashtable());
        }
        ...
        public ActionResult Create(Models.AppVSO03View collection)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(long id, Models.AppVSO03View collection)
        {
            // TODO: Add insert logic here
            try
            {
