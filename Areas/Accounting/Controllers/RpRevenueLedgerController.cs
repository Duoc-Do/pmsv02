...
{
    public class RpRevenueLedgerController : AppAccountingReportController
    {
        DAL.RpRevenueLedger _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.RpRevenueLedger(Request);
        ...
        public ActionResult Print(int sysreportid, string reporttype = "PDF")
        {
            ...
            var result = _dataobject.GetDataCacheAll<Models.RpRevenueLedger>();
