...
{
    public class AppItemGroupTableController : AppAccountingListController
    {
        DAL.AppItemGroupTable _dataobject;

        protected override IActionInvoker CreateActionInvoker()
        {
            _dataobject = new DAL.AppItemGroupTable(Request);
        ...
        {
            DAL.AppItemGroupTable _dataobject = new DAL.AppItemGroupTable(Request);
        ...
        public ActionResult Create(Models.AppItemGroupView collection)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Models.AppItemGroupView collection)
        {
            try
            {
