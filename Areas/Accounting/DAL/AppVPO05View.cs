...
namespace WebApp.Areas.Accounting.DAL
{
    public partial class AppVPO05View : SenVietVoucherObject
    {
        ...
        public void Validate(Models.AppVPO05View data)
        {
            #region ki?m tra chi ti?t

            this._metaobject = Services.GlobalMeta.GetMetaObject(this._metalinename);
            this.ValidateLine(data.AppVPO05LineViews, data.AppVPO05LineViewz);
            ...
            this.ValidateVAT(data.AppVPO05VATViews, data.AppVPO05VATViewz);
            #endregion
        ...
        public List<Models.AppVPO05View> GetData()
        {
            var model = Services.GridHelper.GetResults(this._request, this._metaname, Voucher.RoleFilter(this._db.AppVPO05Views));
            return model;
        }

        public Models.AppVPO05View GetById(long Id)
        {
            return this._db.AppVPO05Views.SingleOrDefault(m => m.DocumentID == Id);
        }

        public Models.AppVPO05View GetNew(long? id)
        {
            ...
            return new Models.AppVPO05View();
        }

        public Models.AppVPO05View GetEdit(long id)
        {
            //ki?m tra quy?n n?u không cho thì ném exception
            return GetById(id);
        }

        public Models.AppVPO05View GetDelete(long id)
        {
            //ki?m tra quy?n n?u không cho thì ném exception
            return GetById(id);
        }
        ...
        public long InsertLine(Models.AppVPO05LineView data)
        {
            try
            {
        ...
        public long UpdateLine(Models.AppVPO05LineView data)
        {
            try
            {
