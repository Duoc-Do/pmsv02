...
{
    public partial class RpCashFlowInDirect : SenVietReportObject
    {
        public RpCashFlowInDirect(HttpRequestBase request) : base(request) { }
        public override void InitObject()
        {
            this._businesscode = "RpCashFlowInDirect";
            this._metaname = "RpCashFlowInDirect";
            this._keyfield = "DocumentID";
            this._storeName = @"sp_RpCashFlowInDirect '{0}','{1}','{2}','{3}'";
            base.InitObject();
        }
        ...
        public List<Models.RpCashFlowInDirect> GetData()
        {
            ...
            List<Models.RpCashFlowInDirect> result = null;
            if (!this.IsSession())
            {
                result = this._db.Database.SqlQuery<Models.RpCashFlowInDirect>(strProcedure).ToList();
            }
            else
            {
                var resultsession = this.GetDataCache<Models.RpCashFlowInDirect>();
            ...
            var model = Services.GridHelper.GetResults(this._request, this._metaname, result.AsQueryable<Models.RpCashFlowInDirect>());
        ...
        public override byte[] ExportToExcel()
        {
            ...
            {
                Export.ExportToXlsx(stream, this.GetDataCacheAll<Models.RpCashFlowInDirect>(), this._metaobject.GetMetaTable());
