...
{
    public partial class AppSalesTaxTable : SenVietListObject
    {
        public AppSalesTaxTable(HttpRequestBase request) : base(request) { }

        public override void InitObject()
        {
            this._businesscode = "AppSalesTaxTable";
            this._metaname = "AppSalesTaxView";
            this._keyfield = "SalesTaxID";
            this._storeNameI = @"sp_AppSalesTaxTableI @SalesTaxID OUTPUT,@SalesTaxCode,@Name,@Percentage,@DisplayNumber,@IsActive,@CreatedBy,@CreatedDateTime,@ModifiedBy,@ModifiedDateTime";
            this._storeNameU = @"sp_AppSalesTaxTableU @SalesTaxID OUTPUT,@SalesTaxCode,@Name,@Percentage,@DisplayNumber,@IsActive,@CreatedBy,@CreatedDateTime,@ModifiedBy,@ModifiedDateTime,@Original_SalesTaxID";
            this._storeNameD = @"sp_AppSalesTaxTableD {0}";
            base.InitObject();
        }

        public List<Models.AppSalesTaxView> GetData()
        {
            var model = Services.GridHelper.GetResults(this._request, this._metaname, this._db.AppSalesTaxViews);
            return model;
        }

        public Models.AppSalesTaxView GetById(int Id)
        {
            return this._db.AppSalesTaxViews.SingleOrDefault(m => m.SalesTaxID == Id);
        }

        public Models.AppSalesTaxView GetNew(int? id)
        {
            if (id != null) return GetById(id ?? 0);
            return new Models.AppSalesTaxView();
        }

        public Models.AppSalesTaxView GetEdit(int id)
        {
            return GetById(id);
        }

        public Models.AppSalesTaxView GetDelete(int id)
        {
            return GetById(id);
        }
        public int Insert(Models.AppSalesTaxView data)
        {
            try
            {
                this.Validate(data);
        ...
        public int Update(Models.AppSalesTaxView data)
        {
            try
            {
                this.Validate(data);
