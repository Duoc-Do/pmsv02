...
{
    public partial class AppVPO01View : SenVietVoucherObject
    {
        public AppVPO01View(HttpRequestBase request) : base(request) { }
        public override void InitObject()
        {
            this._businesscode = "AppVPO01ViewEdit";
            this._keyfieldmaster = "DocumentID";
            this._keyfieldline = "DocumentLineID";
            this._keyfieldvat = "DocumentVATID";

            this._metaname = "AppVPO01View";
            this._metalinename = "AppVPO01LineView";
            this._metavatname = "AppVPO01VATView";


            this._storeNameI = @"sp_AppVPO01ViewI @DocumentID OUTPUT,@ParentID,@VoucherID,@CurrencyID,@ExchangeRate,@VoucherDate,@VoucherNumber,@CustomerID,@Address,@Contact,@Description,@PostType,@AccountCreditID,@DueDate,@CreatedBy,@CreatedDateTime,@ModifiedBy,@ModifiedDateTime";
            this._storeNameU = @"sp_AppVPO01ViewU @DocumentID OUTPUT,@ParentID,@VoucherID,@CurrencyID,@ExchangeRate,@VoucherDate,@VoucherNumber,@CustomerID,@Address,@Contact,@Description,@PostType,@AccountCreditID,@DueDate,@CreatedBy,@CreatedDateTime,@ModifiedBy,@ModifiedDateTime,@Original_DocumentID";
            this._storeNameD = @"sp_AppVPO01ViewD {0}";
            this._storeNameLineI = @"sp_AppVPO01LineViewI @DocumentID,@DocumentLineID OUTPUT,@DocumentLineType,@ParentLineID,@AccountDebitLineID,@AccountCreditLineID,@DescriptionLine,@WarehouseLineID,@ProductID,@ItemID,@UOMID,@Quantity0,@MeasureRate,@Quantity,@UnitPriceFC,@UnitPrice,@Amount,@AmountFC,@AmountCost,@AmountCostFC,@DisCount,@DisCountFC,@DisCountPercentage,@ExObject01ID,@ExObject02ID,@ExObject03ID,@ExObject04ID,@ExObject05ID,@ExObject06ID,@ExObject07ID,@ExObject08ID,@ExObject09ID,@ExObject10ID,@ExDate01,@ExDate02,@ExDate03,@ExDate04,@ExDate05,@ExDate06,@ExString01,@ExString02,@ExString03,@ExString04,@ExString05,@ExString06,@ExNumeric01,@ExNumeric02,@ExNumeric03,@ExNumeric04,@ExNumeric05,@ExNumeric06,@ExNumeric07,@ExNumeric08,@ExNumeric09,@ExNumeric10,@ExObject11ID,@ExObject12ID,@ExObject13ID,@ExObject14ID,@ExObject15ID,@ExObject16ID,@ExObject17ID,@ExObject18ID,@ExObject19ID,@ExObject20ID";
            this._storeNameLineU = @"sp_AppVPO01LineViewU @DocumentID,@DocumentLineID OUTPUT,@DocumentLineType,@ParentLineID,@AccountDebitLineID,@AccountCreditLineID,@DescriptionLine,@WarehouseLineID,@ProductID,@ItemID,@UOMID,@Quantity0,@MeasureRate,@Quantity,@UnitPriceFC,@UnitPrice,@Amount,@AmountFC,@AmountCost,@AmountCostFC,@DisCount,@DisCountFC,@DisCountPercentage,@ExObject01ID,@ExObject02ID,@ExObject03ID,@ExObject04ID,@ExObject05ID,@ExObject06ID,@ExObject07ID,@ExObject08ID,@ExObject09ID
            ...
            if (type == 1)
            {
                switch (fieldname)
                {
                    ...
                    case "ItemCode":
                        ...
                        if (appitem != null)
                        {
                            UnitPrice = Services.Voucher.GetUnitPrice(appitem.ItemID, customerid, voucherdate);
                            UnitPriceFC = Services.Voucher.GetUnitPriceFC(appitem.ItemID, customerid, voucherdate);
                        }
                        results = (new { rows = appitem, extrows = new { UnitPrice = UnitPrice, UnitPriceFC = UnitPriceFC } });
        ...
        public void Validate(Models.AppVPO01View data)
        {
            #region ki?m tra chi ti?t

            this._metaobject = Services.GlobalMeta.GetMetaObject(this._metalinename);
            this.ValidateLine(data.AppVPO01LineViews, data.AppVPO01LineViewz);
            ...
            this.ValidateVAT(data.AppVPO01VATViews, data.AppVPO01VATViewz);
            #endregion
        ...
        public List<Models.AppVPO01View> GetData()
        {
            var model = Services.GridHelper.GetResults(this._request, this._metaname, Voucher.RoleFilter(this._db.AppVPO01Views));
            return model;
        }

        public Models.AppVPO01View GetById(long Id)
        {
            return this._db.AppVPO01Views.SingleOrDefault(m => m.DocumentID == Id);
        }

        public Models.AppVPO01View GetNew(long? id)
        {
            ...
            return new Models.AppVPO01View();
        }

        public Models.AppVPO01View GetEdit(long id)
        {
            //ki?m tra quy?n n?u không cho thì ném exception
            return GetById(id);
        }

        public Models.AppVPO01View GetDelete(long id)
        {
            //ki?m tra quy?n n?u không cho thì ném exception
            return GetById(id);
        }

        public long Insert(Models.AppVPO01View data)
        {
            try
            {
                data.DocumentID = 0;
                ...
                var appvpo01lineviews = data.AppVPO01LineViews.ToList();
                var appvpo01lineviewz = data.AppVPO01LineViewz.ToList();
                for (int i = 0; i < appvpo01lineviews.Count; i++)
                {

                    var itemz = appvpo01lineviewz[i];
                    if (itemz != -1)
                    {
                        var item = appvpo01lineviews[i];
                ...
                #region X? lý VAT
                if (data.AppVPO01VATViews != null)
                {

                    this._metaobject = Services.GlobalMeta.GetMetaObject(this._metavatname);

                    var appvpo01vatviews = data.AppVPO01VATViews.ToList();
                    var appvpo01vatviewz = data.AppVPO01VATViewz.ToList();
                    for (int i = 0; i < appvpo01vatviews.Count; i++)
                    {

                        var itemz = appvpo01vatviewz[i];
                        if (itemz != -1)
                        {
                            var item = appvpo01vatviews[i];
                            item.DocumentID = data.DocumentID;
                            //item.AccountDebitLineID = data.AccountDebitID;
                            item.AccountCreditLineID = data.AccountCreditID;
                            if (data.IsoCode == Services.GlobalVariant.GetSysOption()["IsoCode"].ToString())
        ...
        public long InsertLine(Models.AppVPO01LineView data)
        {
            try
            {
        ...
        public long InsertVAT(Models.AppVPO01VATView data)
        {
            try
            {
        ...
        public long Update(Models.AppVPO01View data)
        {
            try
            {
        ...
        public long UpdateLine(Models.AppVPO01LineView data)
        {
            try
            {
        ...
        public long UpdateVAT(Models.AppVPO01VATView data)
        {
            try
            {
