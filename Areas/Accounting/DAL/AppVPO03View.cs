...
{
    public partial class AppVPO03View : SenVietVoucherObject
    {
        public AppVPO03View(HttpRequestBase request) : base(request) { }
        public override void InitObject()
        {
            this._businesscode = "AppVPO03ViewEdit";
            this._keyfieldmaster = "DocumentID";
            this._keyfieldline = "DocumentLineID";
            this._keyfieldvat = "DocumentVATID";

            this._metaname = "AppVPO03View";
            this._metalinename = "AppVPO03LineView";
            this._metavatname = "AppVPO03VATView";


            this._storeNameI = @"sp_AppVPO03ViewI @DocumentID OUTPUT,@ParentID,@VoucherID,@CurrencyID,@ExchangeRate,@VoucherDate,@VoucherNumber,@CustomerID,@Address,@Contact,@Description,@PostType,@IsFixPrice,@AccountDebitID,@AccountCreditID,@CreatedBy,@CreatedDateTime,@ModifiedBy,@ModifiedDateTime";
            this._storeNameU = @"sp_AppVPO03ViewU @DocumentID OUTPUT,@ParentID,@VoucherID,@CurrencyID,@ExchangeRate,@VoucherDate,@VoucherNumber,@CustomerID,@Address,@Contact,@Description,@PostType,@IsFixPrice,@AccountDebitID,@AccountCreditID,@CreatedBy,@CreatedDateTime,@ModifiedBy,@ModifiedDateTime,@Original_DocumentID";
            this._storeNameD = @"sp_AppVPO03ViewD {0}";
            this._storeNameLineI = @"sp_AppVPO03LineViewI @DocumentID,@DocumentLineID OUTPUT,@DocumentLineType,@ParentLineID,@AccountDebitLineID,@AccountCreditLineID,@DescriptionLine,@WarehouseLineID,@ProductID,@ItemID,@UOMID,@Quantity0,@MeasureRate,@Quantity,@UnitPriceFC,@UnitPrice,@Amount,@AmountFC,@AmountCost,@AmountCostFC,@ExObject01ID,@ExObject02ID,@ExObject03ID,@ExObject04ID,@ExObject05ID,@ExObject06ID,@ExObject07ID,@ExObject08ID,@ExObject09ID,@ExObject10ID,@ExDate01,@ExDate02,@ExDate03,@ExDate04,@ExDate05,@ExDate06,@ExString01,@ExString02,@ExString03,@ExString04,@ExString05,@ExString06,@ExNumeric01,@ExNumeric02,@ExNumeric03,@ExNumeric04,@ExNumeric05,@ExNumeric06,@ExNumeric07,@ExNumeric08,@ExNumeric09,@ExNumeric10,@ExObject11ID,@ExObject12ID,@ExObject13ID,@ExObject14ID,@ExObject15ID,@ExObject16ID,@ExObject17ID,@ExObject18ID,@ExObject19ID,@ExObject20ID";
            this._storeNameLineU = @"sp_AppVPO03LineViewU @DocumentID,@DocumentLineID OUTPUT,@DocumentLineType,@ParentLineID,@AccountDebitLineID,@AccountCreditLineID,@DescriptionLine,@WarehouseLineID,@ProductID,@ItemID,@UOMID,@Quantity0,@MeasureRate,@Quantity,@UnitPriceFC,@UnitPrice,@Amount,@AmountFC,@AmountCost,@AmountCostFC,@ExObject01ID,@ExObject02
            this._storeNameVATD = @"sp_AppVPO03VATViewD {0}";
        ...
        public void Validate(Models.AppVPO03View data)
        {
            #region ki?m tra chi ti?t

            this._metaobject = Services.GlobalMeta.GetMetaObject(this._metalinename);
            this.ValidateLine(data.AppVPO03LineViews, data.AppVPO03LineViewz);
            ...
            this.ValidateVAT(data.AppVPO03VATViews, data.AppVPO03VATViewz);
            #endregion
        ...
        public List<Models.AppVPO03View> GetData()
        {
            var model = Services.GridHelper.GetResults(this._request, this._metaname,Voucher.RoleFilter( this._db.AppVPO03Views));
            return model;
        }

        public Models.AppVPO03View GetById(long Id)
        {
            return this._db.AppVPO03Views.SingleOrDefault(m => m.DocumentID == Id);
        }

        public Models.AppVPO03View GetNew(long? id)
        {
            ...
            return new Models.AppVPO03View();
        }

        public Models.AppVPO03View GetEdit(long id)
        {
            //ki?m tra quy?n n?u không cho thì ném exception
            return GetById(id);
        }

        public Models.AppVPO03View GetDelete(long id)
        {
            //ki?m tra quy?n n?u không cho thì ném exception
            return GetById(id);
        }

        public long Insert(Models.AppVPO03View data)
        {
            try
            {
                data.DocumentID = 0;
                ...
                var appvpo03lineviews = data.AppVPO03LineViews.ToList();
                var appvpo03lineviewz = data.AppVPO03LineViewz.ToList();
                for (int i = 0; i < appvpo03lineviews.Count; i++)
                {

                    var itemz = appvpo03lineviewz[i];
                    if (itemz != -1)
                    {
                        var item = appvpo03lineviews[i];
                ...
                #region X? lý VAT
                if (data.AppVPO03VATViews != null)
                {

                    this._metaobject = Services.GlobalMeta.GetMetaObject(this._metavatname);

                    var appvpo03vatviews = data.AppVPO03VATViews.ToList();
                    var appvpo03vatviewz = data.AppVPO03VATViewz.ToList();
                    for (int i = 0; i < appvpo03vatviews.Count; i++)
                    {

                        var itemz = appvpo03vatviewz[i];
                        if (itemz != -1)
                        {
                            var item = appvpo03vatviews[i];
                            item.DocumentID = data.DocumentID;
                            item.AccountDebitLineID = data.AccountDebitID;
                            if (data.IsoCode == Services.GlobalVariant.GetSysOption()["IsoCode"].ToString())
                            {
        ...
        public long InsertLine(Models.AppVPO03LineView data)
        {
            try
            {
        ...
        public long InsertVAT(Models.AppVPO03VATView data)
        {
            try
            {
        ...
        public long Update(Models.AppVPO03View data)
        {
            try
            {
        ...
        public long UpdateLine(Models.AppVPO03LineView data)
        {
            try
            {
        ...
        public long UpdateVAT(Models.AppVPO03VATView data)
        {
            try
            {
