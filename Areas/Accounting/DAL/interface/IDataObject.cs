...
namespace WebApp.Areas.Accounting.DAL
{
    ...
    {
        public Models.WebAppAccEntities _db;
        ...
        {
            var metatable = Services.GlobalMeta.GetMetaObject(this._businesscode).MetaTable;//lấy meta của bảng gốc
    ...
    public abstract class SenVietListObject
    {
        ...
        public virtual void MapCode2Id(dynamic data) { }
        ...
        public virtual void ImportFromExcel(Stream stream) { }
