...
{
    public partial class AppVIN04View : SenVietVoucherObject
    {
        public AppVIN04View(HttpRequestBase request) : base(request) { }
        public override void InitObject()
        {
            this._businesscode = "AppVIN04ViewEdit";
            this._keyfieldmaster = "DocumentID";
            this._keyfieldline = "DocumentLineID";
            //this._keyfieldvat = "DocumentVATID";

            this._metaname = "AppVIN04View";
            this._metalinename = "AppVIN04LineView";
            //this._metavatname = "AppVIN04VATView";


            this._storeNameI = @"sp_AppVIN04ViewI @DocumentID OUTPUT,@ParentID,@VoucherID,@CurrencyID,@ExchangeRate,@VoucherDate,@VoucherNumber,@CustomerID,@Address,@Contact,@Description,@PostType,@IsFixPrice,@CreatedBy,@CreatedDateTime,@ModifiedBy,@ModifiedDateTime";
            this._storeNameU = @"sp_AppVIN04ViewU @DocumentID OUTPUT,@ParentID,@VoucherID,@CurrencyID,@ExchangeRate,@VoucherDate,@VoucherNumber,@CustomerID,@Address,@Contact,@Description,@PostType,@IsFixPrice,@CreatedBy,@CreatedDateTime,@ModifiedBy,@ModifiedDateTime,@Original_DocumentID";
            this._storeNameD = @"sp_AppVIN04ViewD {0}";
            this._storeNameLineI = @"sp_AppVIN04LineViewI @DocumentID,@DocumentLineID OUTPUT,@DocumentLineType,@ParentLineID,@AccountDebitLineID,@AccountCreditLineID,@DescriptionLine,@WarehouseLineID,@ProductID,@ItemID,@UOMID,@Quantity0,@MeasureRate,@Quantity,@UnitPriceFC,@UnitPrice,@Amount,@AmountFC,@ExObject01ID,@ExObject02ID,@ExObject03ID,@ExObject04ID,@ExObject05ID,@ExObject06ID,@ExObject07ID,@ExObject08ID,@ExObject09ID,@ExObject10ID,@ExDate01,@ExDate02,@ExDate03,@ExDate04,@ExDate05,@ExDate06,@ExString01,@ExString02,@ExString03,@ExString04,@ExString05,@ExString06,@ExNumeric01,@ExNumeric02,@ExNumeric03,@ExNumeric04,@ExNumeric05,@ExNumeric06,@ExNumeric07,@ExNumeric08,@ExNumeric09,@ExNumeric10,@ExObject11ID,@ExObject12ID,@ExObject13ID,@ExObject14ID,@ExObject15ID,@ExObject16ID,@ExObject17ID,@ExObject18ID,@ExObject19ID,@ExObject20ID";
            this._storeNameLineU = @"sp_AppVIN04LineViewU @DocumentID,@DocumentLineID OUTPUT,@DocumentLineType,@ParentLineID,@AccountDebitLineID,@AccountCreditLineID,@DescriptionLine,@WarehouseLineID,@ProductID,@ItemID,@UOMID,@Quantity0,@MeasureRate,@Quantity,@UnitPriceFC,@UnitPrice,@Amount,@AmountFC,@ExObject01ID,@ExObject02ID,@ExObject03ID,@ExObject04ID,@ExObject05ID,@ExObject06ID,@ExObject07ID,@ExObject08ID,@ExObject09ID,@ExObject10ID,@ExDate01,@ExDate02,@ExDate03,@ExDate04,@ExDate05,@ExDate06,@ExString01,@ExString02,@ExString03,@ExString04,@ExString05,@ExString06,@ExNumeric01,@ExNumeric02,@ExNumeric03,@ExNumeric04,@ExNumeric05,@ExNumeric06,@ExNumeric07,@ExNumeric08,@ExNumeric09,@ExNumeric10,@ExObject11ID,@ExObject12ID,@ExObject13ID,@ExObject14ID,@ExObject15ID,@ExObject16ID,@ExObject17ID,@ExObject18ID,@ExObject19ID,@ExObject20ID,@Original_DocumentLineID";
            this._storeNameLineD = @"sp_AppVIN04LineViewD {0}";
            //this._storeNameVATI = @"sp_AppVIN04VATViewI ";
            //this._storeNameVATU = @"sp_AppVIN04VATViewU ";
            //this._storeNameVATD = @"sp_AppVIN04VATViewD {0}";
        ...
        public void Validate(Models.AppVIN04View data)
        {
            #region ki?m tra chi ti?t

            this._metaobject = Services.GlobalMeta.GetMetaObject(this._metalinename);
            this.ValidateLine(data.AppVIN04LineViews, data.AppVIN04LineViewz);
            ...
            //this.ValidateVAT(data.AppVIN04VATViews, data.AppVIN04VATViewz);
            //#endregion
        ...
        public List<Models.AppVIN04View> GetData()
        {
            var model = Services.GridHelper.GetResults(this._request, this._metaname, Voucher.RoleFilter(this._db.AppVIN04Views));
            return model;
        }

        public Models.AppVIN04View GetById(long Id)
        {
            return this._db.AppVIN04Views.SingleOrDefault(m => m.DocumentID == Id);
        }

        public Models.AppVIN04View GetNew(long? id)
        {
            ...
            return new Models.AppVIN04View();
        }

        public Models.AppVIN04View GetEdit(long id)
        {
            //ki?m tra quy?n n?u không cho thì ném exception
            return GetById(id);
        }

        public Models.AppVIN04View GetDelete(long id)
        {
            //ki?m tra quy?n n?u không cho thì ném exception
            return GetById(id);
        }

        public long Insert(Models.AppVIN04View data)
        {
            try
            {
                data.DocumentID = 0;
                ...
                var appvin04lineviews = data.AppVIN04LineViews.ToList();
                var appvin04lineviewz = data.AppVIN04LineViewz.ToList();
                for (int i = 0; i < appvin04lineviews.Count; i++)
                {

                    var itemz = appvin04lineviewz[i];
                    if (itemz != -1)
                    {
                        var item = appvin04lineviews[i];
                ...
                //#region X? lý VAT
                //if (data.AppVIN04VATViews != null)
                //{

                //    this._metaobject = Services.GlobalMeta.GetMetaObject(this._metavatname);

                //    var appvin04vatviews = data.AppVIN04VATViews.ToList();
                //    var appvin04vatviewz = data.AppVIN04VATViewz.ToList();
                //    for (int i = 0; i < appvin04vatviews.Count; i++)
                //    {

                //        var itemz = appvin04vatviewz[i];
                //        if (itemz != -1)
                //        {
                //            var item = appvin04vatviews[i];
                //            item.DocumentID = data.DocumentID;
                //            item.AccountDebitLineID = data.AccountDebitID;
                //            if (data.IsoCode == Services.GlobalVariant.GetSysOption()["IsoCode"].ToString())
                //            {
        ...
        public long InsertLine(Models.AppVIN04LineView data)
        {
            try
            {
        ...
        //public long InsertVAT(Models.AppVIN04VATView data)
        //{
        //    try
        //    {
        ...
        public long Update(Models.AppVIN04View data)
        {
            try
            {
        ...
        public long UpdateLine(Models.AppVIN04LineView data)
        {
            try
            {
        ...
        //public long UpdateVAT(Models.AppVIN04VATView data)
        //{
        //    try
        //    {
