...
namespace WebApp.Areas.Accounting.Models
{
    ...
    [Table("AppVCA03View")]
    public partial class AppVCA03View
    {
        public AppVCA03View()
        {
            this.AppVCA03LineViews = new HashSet<AppVCA03LineView>();
            this.AppVCA03VATViews = new HashSet<AppVCA03VATView>();
            ...
            this.VoucherID = Services.Voucher.GetVoucherID("CA03");
        ...
        public virtual ICollection<AppVCA03LineView> AppVCA03LineViews { get; set; }
        public virtual ICollection<AppVCA03VATView> AppVCA03VATViews { get; set; }

        public virtual ICollection<long> AppVCA03LineViewz { get; set; }
        public virtual ICollection<long> AppVCA03VATViewz { get; set; }
