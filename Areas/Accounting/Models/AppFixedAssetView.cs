...
namespace WebApp.Areas.Accounting.Models
{
    ...
    [Table("AppFixedAssetView")]
    public partial class AppFixedAssetView
    {
        public AppFixedAssetView()
        {
            this.AppFixedAssetLineTables = new HashSet<AppFixedAssetLineTable>();
            this.AppEquipmentTables = new HashSet<AppEquipmentTable>();
            this.IsActive = true;
        }

        public virtual ICollection<AppFixedAssetLineTable> AppFixedAssetLineTables { get; set; }
        public virtual ICollection<AppEquipmentTable> AppEquipmentTables { get; set; }

        public virtual ICollection<int> AppFixedAssetLineTablez { get; set; }
        public virtual ICollection<int> AppEquipmentTablez { get; set; }
