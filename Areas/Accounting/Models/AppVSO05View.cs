...
namespace WebApp.Areas.Accounting.Models
{
    ...
    [Table("AppVSO05View")]
    public partial class AppVSO05View
    {
        public AppVSO05View()
        {
            this.AppVSO05LineViews = new HashSet<AppVSO05LineView>();
            this.AppVSO05VATViews = new HashSet<AppVSO05VATView>();
            ...
            this.VoucherID = Services.Voucher.GetVoucherID("SO05");
        ...
        public virtual ICollection<AppVSO05LineView> AppVSO05LineViews { get; set; }
        public virtual ICollection<AppVSO05VATView> AppVSO05VATViews { get; set; }

        public virtual ICollection<long> AppVSO05LineViewz { get; set; }
        public virtual ICollection<long> AppVSO05VATViewz { get; set; }
