...
namespace WebApp.Areas.Accounting.Models
{
    ...
    [Table("AppVSO01View")]
    public partial class AppVSO01View
    {
        public AppVSO01View()
        {
            this.AppVSO01LineViews = new HashSet<AppVSO01LineView>();
            this.AppVSO01VATViews = new HashSet<AppVSO01VATView>();
            ...
            this.VoucherID = Services.Voucher.GetVoucherID("SO01");
        ...
        public virtual ICollection<AppVSO01LineView> AppVSO01LineViews { get; set; }
        public virtual ICollection<AppVSO01VATView> AppVSO01VATViews { get; set; }

        public virtual ICollection<long> AppVSO01LineViewz { get; set; }
        public virtual ICollection<long> AppVSO01VATViewz { get; set; }
