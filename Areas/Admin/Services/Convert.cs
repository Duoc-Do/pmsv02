...
namespace WebApp.Areas.Admin.Services
{
    public static class ExConvert
    {
        ...
        {
            System.Globalization.CultureInfo _cultureinfo = (System.Globalization.CultureInfo)Services.GlobalVariant.GetCultureInfo()["CICC"];
            return decimal.Parse(value, _cultureinfo.NumberFormat);
        }
    ...
    public static class Extension
    {
        ...
        public static string RelativeFormat(this DateTime date)
        {
            return ExConvert.RelativeFormat(date);
        }
        ...
        public static DateTime EndOfMonth(this DateTime date)
        {
            ...
            return new DateTime(date2.Year, date2.Month, date2.Day, 0, 0, 0, 0);
        }
