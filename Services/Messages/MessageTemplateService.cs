...
//{
//    public partial class SenMessageTemplateService : ISenMessageTemplateService
//    {
//        #region Constants
...
//        /// {0} : store ID
//        /// </remarks>
//        private const string MESSAGETEMPLATES_ALL_KEY = "WebApp.messagetemplate.all-{0}";
//        /// <summary>
//        /// Key for caching
//        /// </summary>
//        /// <remarks>
...
//        /// {1} : store ID
//        /// </remarks>
//        private const string MESSAGETEMPLATES_BY_NAME_KEY = "WebApp.messagetemplate.name-{0}-{1}";
//        /// <summary>
//        /// Key pattern to clear cache
//        /// </summary>
//        private const string MESSAGETEMPLATES_PATTERN_KEY = "WebApp.messagetemplate.";

//        #endregion

//        #region Fields

//        private readonly IRepository<SenMessageTemplate> _messageTemplateRepository;
...
//        public SenMessageTemplateService(ICacheManager cacheManager,
//            IRepository<StoreMapping> storeMappingRepository,
//            ILanguageService languageService,
//            ILocalizedEntityService localizedEntityService,
//            IStoreMappingService storeMappingService,
//            IRepository<SenMessageTemplate> messageTemplateRepository,
...
//        public virtual void DeleteSenMessageTemplate(SenMessageTemplate messageTemplate)
//        {
...
//        /// </summary>
//        /// <param name="messageTemplate">Message template</param>
//        public virtual void InsertSenMessageTemplate(SenMessageTemplate messageTemplate)
//        {
//            if (messageTemplate == null)
//                throw new ArgumentNullException("messageTemplate");
...
//        /// </summary>
//        /// <param name="messageTemplate">Message template</param>
//        public virtual void UpdateSenMessageTemplate(SenMessageTemplate messageTemplate)
//        {
//            if (messageTemplate == null)
//                throw new ArgumentNullException("messageTemplate");
...
//        public virtual SenMessageTemplate GetSenMessageTemplateById(int messageTemplateId)
//        {
...
//        /// <returns>Message template</returns>
//        public virtual SenMessageTemplate GetSenMessageTemplateByName(string messageTemplateName, int storeId)
//        {
...
//                            on new { c1 = t.Id, c2 = "SenMessageTemplate" } equals new { c1 = sm.EntityId, c2 = sm.EntityName } into t_sm
...
//        public virtual IList<SenMessageTemplate> GetAllSenMessageTemplates(int storeId)
//        {
...
//        public virtual SenMessageTemplate CopySenMessageTemplate(SenMessageTemplate messageTemplate)
//        {
//            if (messageTemplate == null)
//                throw new ArgumentNullException("messageTemplate");

//            var mtCopy = new SenMessageTemplate()
//                             {
...
//            InsertSenMessageTemplate(mtCopy);
