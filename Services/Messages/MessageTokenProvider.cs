...
//using WebApp.Core.Domain.Tax;
//using WebApp.Core.Html;
//using WebApp.Services.Catalog;
//using WebApp.Services.Common;
//using WebApp.Services.Customers;
//using WebApp.Services.Directory;
//using WebApp.Services.Events;
//using WebApp.Services.Forums;
//using WebApp.Services.Helpers;
//using WebApp.Services.Localization;
//using WebApp.Services.Media;
//using WebApp.Services.Orders;
//using WebApp.Services.Payments;
//using WebApp.Services.Seo;
...
//            #region Products
//            sb.AppendLine(string.Format("<tr style=\"color:#FFFFFF;background-color:{0};text-align:center;\">", _templatesSettings.Color1));
...
//                sb.AppendLine(string.Format("<tr style=\"color:#FFFFFF;text-align:right;\"><td>&nbsp;</td><td colspan=\"2\" style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{1}</strong></td> <td style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{2}</strong></td></tr>", _templatesSettings.Color3, paymentMethodFeeTitle, cusPaymentMethodAdditionalFee));
//            }
...
//                    sb.AppendLine(string.Format("<tr style=\"color:#FFFFFF;text-align:right;\"><td>&nbsp;</td><td colspan=\"2\" style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{1}</strong></td> <td style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{2}</strong></td></tr>", _templatesSettings.Color3, taxRate, taxValue));
//                }
//            }
...
//                sb.AppendLine(string.Format("<tr style=\"color:#FFFFFF;text-align:right;\"><td>&nbsp;</td><td colspan=\"2\" style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{1}</strong></td> <td style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{2}</strong></td></tr>", _templatesSettings.Color3, giftCardText, giftCardAmount));
//            }
...
//                sb.AppendLine(string.Format("<tr style=\"color:#FFFFFF;text-align:right;\"><td>&nbsp;</td><td colspan=\"2\" style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{1}</strong></td> <td style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{2}</strong></td></tr>", _templatesSettings.Color3, rpTitle, rpAmount));
//            }
