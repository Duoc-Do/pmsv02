...
namespace WebApp.Services.Messages
{
    public partial interface IQueuedEmailService
    {
        ...
        void InsertQueuedEmail(SenQueuedEmail queuedEmail);

        /// <summary>
        /// Updates a queued email
        /// </summary>
        /// <param name="queuedEmail">Queued email</param>
        void UpdateQueuedEmail(SenQueuedEmail queuedEmail);

        /// <summary>
        /// Deleted a queued email
        /// </summary>
        /// <param name="queuedEmail">Queued email</param>
        void DeleteQueuedEmail(SenQueuedEmail queuedEmail);
        ...
        SenQueuedEmail GetQueuedEmailById(int queuedEmailId);
        ...
        IList<SenQueuedEmail> GetQueuedEmailsByIds(int[] queuedEmailIds);
        ...
        IList<SenQueuedEmail> SearchEmails(string fromEmail,
