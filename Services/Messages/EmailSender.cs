...
namespace WebApp.Services.Messages
{
    public partial class EmailSender : IEmailSender
    {
        ...
        public void SendEmail(SenEmailAccount emailAccount, string subject, string body,
        ...
        /// <param name="bcc">BCC addresses list</param>
        /// <param name="cc">CC addresses ist</param>
        public virtual void SendEmail(SenEmailAccount emailAccount, string subject, string body,
