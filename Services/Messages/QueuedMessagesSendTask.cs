...
namespace WebApp.Services.Messages
{
    ...
    public partial class QueuedMessagesSendTask : ITask
    {
        ...
        public QueuedMessagesSendTask()
        {
           ...
           ILogger logger;
           queuedEmailService = new QueuedEmailService(_db);
        ...
        public void Execute()
        {
            ...
            {
                var EmailAccount = _db.SenEmailAccounts.SingleOrDefault(m=>m.EmailAccountId==queuedEmail.EmailAccountId);
                ...
                try
                {
                    ...
                    _emailSender.SendEmail(EmailAccount, queuedEmail.Subject, queuedEmail.Body,
