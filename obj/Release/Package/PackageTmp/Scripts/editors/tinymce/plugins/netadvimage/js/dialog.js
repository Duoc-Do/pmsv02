    ...
    if (GetNodeValue(node)) {
        ...
        $.post("_GetImages", { path: GetNodeValue(node) }, function (result) {
            ...
            if ($(result).size() > 0) {
                ...
                $('#directory img').attr('src', '/Scripts/editors/tinymce/plugins/netadvimage/img/folder-horizontal.gif');
                $(node).closest('.t-item').find('img:first').attr('src', '/Scripts/editors/tinymce/plugins/netadvimage/img/folder-horizontal-open.gif');
    ...
    init: function (ed) {
        ...
        var f = document.forms['mce'],
                ...
                uploader = new qq.FileUploader({
                    ...
                    action: '/Scripts/editors/tinymce/plugins/netadvimage/index',
                    params: {
                        path: null
                    },
                    ...
                    strings: {
                        upload: "Chọn hình",
                        drop: "Kéo file vào đây để tải lên",
                        cancel: "Hủy",
                        failed: "Thất bại"
                    }
                });
