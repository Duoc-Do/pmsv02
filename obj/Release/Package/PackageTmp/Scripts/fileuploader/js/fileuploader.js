...
qq.FileUploaderBasic = function(o){
    this._options = {
        ...
        /**
        * nopCommerce custom code (localization). 
        * Fork here (https://github.com/valums/file-uploader/pull/132). let's wait until it's officially supported.
        */
 	    strings: {
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
                ...
                '<div class="qq-upload-button btn btn-primary btn-flat">{upload}</div>' +
    ...
    var message = this._options.template;
    var message = this._options.template;
    function r(name, replacement){ message = message.replace(name, replacement); }
    r('{drop}', this._options.strings.drop);
    r('{upload}', this._options.strings.upload);
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _addToList: function(id, fileName){
        var message = this._options.fileTemplate;
        function r(name, replacement){ message = message.replace(name, replacement); }
        r('{cancel}', this._options.strings.cancel);
        r('{failed}', this._options.strings.failed);
        var item = qq.toElement(message);        
        item.qqFileId = id;
...
qq.extend(qq.UploadHandlerForm.prototype, {
    ...
    */
    _getIframeContentJSON: function (iframe) {
        ...
        * Reported here (https://github.com/valums/file-uploader/issues/270). let's wait until it's officially fixed.
        */
